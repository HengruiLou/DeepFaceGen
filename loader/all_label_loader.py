...
from loader.datasets.csv_dataset import Dataset_Csv_all_label
...
def load_images(data_type=None, data_name=None):
    ...
    if data_type == 'train':
        ...
        data_set = Dataset_Csv_all_label(train_list, train_label, transform=transform)
        ...
        data_set = Dataset_Csv_all_label(test_list, test_label, transform=transform)
